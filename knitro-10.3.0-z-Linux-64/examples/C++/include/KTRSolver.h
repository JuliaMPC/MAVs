...
class KTRSolver : public KTRISolver {
 ...
 private:
  ...
  /**
   * DEPRECATED Called before solve to register complementarity constraints with KNITRO solver, using complementarity information specified in the KTRIProblem object pointed to by this object. This function should not be called manually.
