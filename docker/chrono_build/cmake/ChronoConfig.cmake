...
if (${CMAKE_SYSTEM_NAME} MATCHES "Windows")
  ...
  set(CHRONO_LINKER_FLAGS "-L/opt/chrono/chrono_build/lib64")
endif()

list(APPEND CHRONO_INCLUDE_DIRS "/opt/chrono/chrono_source/chrono/src;/opt/chrono/chrono_source/chrono/src/chrono;/opt/chrono/chrono_source/chrono/src/chrono/collision/bullet;/opt/chrono/chrono_source/chrono/src/chrono/collision/gimpact;/opt/chrono/chrono_source/chrono/src/chrono/collision/convexdecomposition/HACD;/opt/chrono/chrono_build")
...
set(CHRONO_DATA_DIR "/opt/chrono/chrono_source/chrono/data/")
set(CHRONO_VEHICLE_DATA_DIR "/opt/chrono/chrono_source/chrono/data/vehicle/")
set(CHRONO_FSI_DATA_DIR "/opt/chrono/chrono_source/chrono/data/fsi/")
...
foreach(COMPONENT ${Chrono_FIND_COMPONENTS})
  ...
  if(NOT Chrono_HAS_${COMPONENT_LOWER})
    ...
    if(${COMPONENT_UPPER} MATCHES "PARALLEL")
      ...
      # Chrono::Parallel depends on Chrono::FEA if it was enabled
      if(Chrono_HAS_fea)
    ...
    elseif(${COMPONENT_UPPER} MATCHES "IRRLICHT")
      ...
      list(APPEND CHRONO_INCLUDE_DIRS "/usr/local/include/irrlicht")
    ...
    elseif(${COMPONENT_UPPER} MATCHES "VEHICLE")
      ...
      # Chrono::Vehicle depends on Chrono::FEA if it was enabled
      if(Chrono_HAS_fea)
         list(APPEND CHRONO_LIB_NAMES "ChronoEngine_fea")
         list(APPEND CHRONO_DLL_NAMES "ChronoEngine_fea.dll")
      endif()
...
foreach(lib ${CHRONO_LIB_NAMES})
  ...
  find_library(onelib ${lib}
    PATHS "/opt/chrono/chrono_build/lib64"
...
if(${CMAKE_SYSTEM_NAME} MATCHES "Windows")
  ...
  foreach(dll ${CHRONO_DLL_NAMES})
    ...
    find_file(onedll ${dll}
      PATHS "/opt/chrono/chrono_build/bin"
      PATH_SUFFIXES "Release"
      NO_DEFAULT_PATH
    )
    if(NOT onedll)
...
function(add_DLL_copy_command DLL_LIST)
    ...
    message("Attention: the COPY_DLLS routine will first look for Chrono libraries under the /bin and /lib64 subfolders of /opt/chrono/chrono_build")
